...
def create_causal_block_mask_for_flex_attention(
    ...
    Inputs:
        token_counter: A tensor of integers of length batch_size, where each
        integer is the number of tokens in the batch
    ...
    return create_block_mask(
        flex_decode_mask(token_counter),
        B=batch_size,
        H=None,
        Q_LEN=1,
        KV_LEN=kv_len,
