# Copyright 2023-2024 Parallel Software and Systems Group, University of Maryland.  # noqa: E501
...
@torch.no_grad()
def extract_local_params_from_full_params(params, in_features_group):
...
class TPRMSNorm(torch.nn.Module):
    ...
    def _is_full_weight(self, weight):
        return weight.ndim == 1 and weight.size(0) == self.global_size
